...
export default function Page() {
  ...
  return (
    <div className="flex p-4 h-screen relative overflow-hidden w-full flex-wrap text-center font-mono flex-col ">
      ...
      {folder ? (
        <Draggable>
          <div className="-translate-x-1/2 text-start pl-2 pb-2 -translate-y-1/2 flex-col z-10 absolute max-w-7xl w-full flex bg-white border-gray-200 rounded-lg bg-opacity-75">
